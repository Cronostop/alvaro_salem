...
10. En FABLAB ESAN usamos la cortadora laser **CO2 AVR 1400**. La superficie de corte para esta maquina es de 500x300mm. Para lanzar los cortes usamos el plugin Coreldraw.
![](../images/MT03/10.jpg)
...
El diseño cumple con los requisitos de la asignatura además de incorporar kerfing, pero luego de fabricarlo se percibe que los ensambles deben ser mejorados para lograr mas estabilidad. Para este modelo se usaron ensambles ´finger joint´. 

11. En el segundo prototipo se usaron ensambles tipo Ranura y Lengüeta (Slot & Tab) que logran mayor estabilidad. Usamos Fusion y Autod para modificar el diseño
